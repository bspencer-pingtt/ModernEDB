...
class AccountJournal(models.Model):
    ...
    def _compute_outbound_payment_method_ids(self):
        ...
        for journal in self:
            if journal.type == 'cash':
                check_method = self.env.ref('ping_account_check_printing.account_payment_method_check')
    ...
    def _default_outbound_payment_methods(self):
        ...
        return methods + self.env.ref('ping_account_check_printing.account_payment_method_check')
