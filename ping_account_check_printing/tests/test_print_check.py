...
from odoo.addons.ping_account_check_printing.models.account_payment import INV_LINES_PER_STUB
...
class TestPrintCheck(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.payment_method_check = cls.env.ref("ping_account_check_printing.account_payment_method_check")
    ...
    def test_in_invoice_check_manual_sequencing(self):
        ...
        # Check pages.
        self.company_data['company'].ping_account_check_printing_multi_stub = True
        report_pages = payment._check_get_pages()
        self.assertEqual(len(report_pages), int(math.ceil(len(in_invoices) / INV_LINES_PER_STUB)))

        self.company_data['company'].ping_account_check_printing_multi_stub = False
        report_pages = payment._check_get_pages()
